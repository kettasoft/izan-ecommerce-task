...
return [
    ...
    'paths' => [
        ...
        */
        'generator' => [
            ...
            'resource' => ['path' => 'src/Transformers', 'generate' => true],
            ...
            'scopes' => ['path' => 'src/Models/Scopes', 'generate' => true],
            'relations' => ['path' => 'src/Models/Relations', 'generate' => true],
            'traits' => ['path' => 'src/Traits', 'generate' => true],

            // src/Http/
            'controller' => ['path' => 'src/Http/Controllers', 'generate' => true],
            'middleware' => ['path' => 'src/Http/Middleware', 'generate' => true],
            'request' => ['path' => 'src/Http/Requests', 'generate' => true],
            'filter' => ['path' => 'src/Http/Filters', 'generate' => true],
    ...
    */
    'composer' => [
        'vendor' => env('MODULE_VENDOR', 'abdalrhman'),
        'author' => [
            'name' => env('MODULE_AUTHOR_NAME', 'Abdalrhman Emad Saad'),
            'email' => env('MODULE_AUTHOR_EMAIL', 'abdalrhman@darauction.com'),
        ],
